...
public class GreatWeatherSyncAdapter extends AbstractThreadedSyncAdapter {
    public final String LOG_TAG = GreatWeatherSyncAdapter.class.getSimpleName();
    ...
    public GreatWeatherSyncAdapter(Context context, boolean autoInitialize) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    NotificationCompat.Builder mBuilder =
                            new NotificationCompat.Builder(getContext())
                                    .setColor(resources.getColor(R.color.greatweather_light_blue))
                                    .setSmallIcon(iconId)
    ...
    private static void onAccountCreated(Account newAccount, Context context) {
         ...
         */
        GreatWeatherSyncAdapter.configurePeriodicSync(context, SYNC_INTERVAL, SYNC_FLEXTIME);
