...
/**
 * Manages "Authentication" to GreatWeather's backend service.  The SyncAdapter framework
 ...
 */
public class GreatWeatherAuthenticator extends AbstractAccountAuthenticator {

    public GreatWeatherAuthenticator(Context context) {
        super(context);
    }
